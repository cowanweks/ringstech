...
function CartItem() {
  ...
  return <div id='CartItem' className="grid grid-cols-5 bg-white py-8 px-4">
...
export default function Cart() {
  ...
  return (
    <div id='Cart' className="bg-[#eaeded]">
      <Header />
      <div className="grid grid-cols-5 min-h-[100dvh] p-4 gap-x-4">
