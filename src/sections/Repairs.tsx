...
import Image5 from "@public/repairs/speaaker and Microphone Repair.jpg"
...
const items = [
	{
		...
		description: "Fixing mulfunctioning home buttons, or power buttons."
	},
	{
		image: Image2,
		service: "Camera Repair",
		description: "Repairing or replacing of faulty Cameras"
	},
	{
		image: Image3,
		service: "Motherboard Repair",
		description: "Addressing compleax internal issues involving the phone's motherboard"
	},
	{
		image: Image4,
	...
	},
	{
		image: Image5,
		service: "",
		description: "Speaker & Microphone Repair"
	}
]
...
export default function LifeStyle() {
	...
	return (
		<section id="Repairs" className="min-h-dvh px-4 py-16">
			...
			<div className="accessories grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-6">
