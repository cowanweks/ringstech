  ...
  return (
    <nav id="NavBar" className="flex items-center justify-between px-4">
      ...
      <ul className="navs flex gap-x-8 items-center">
        ...
        <li className="nav_item inline mb-0 cursor-pointer text-black"><NavLink to="/">SMARTPHONES</NavLink></li>
        <li className="nav_item inline mb-0 cursor-pointer text-black"><NavLink to="/">POWERBANKS</NavLink></li>
        <li className="nav_item inline mb-0 cursor-pointer text-black"><NavLink to="/">ACCESSORIES</NavLink></li>
        <li className="nav_item inline mb-0 cursor-pointer text-black"><NavLink to="/">COVERS & PROTECTORS</NavLink></li>
