  ...
  return (
    <nav id="NavBar" className="flex items-center justify-between px-4">
      ...
      <ul className="navs flex gap-x-8 items-center">
        <li className="nav_item inline mb-0 cursor-pointer text-[#C5C6C7]">
          <Link to="/shop">SHOP</Link>
        </li>
        <li className="nav_item inline mb-0 text-[#C5C6C7]"><Link to="/">SMARTPHONES</Link></li>
        <li className="nav_item inline mb-0 text-[#C5C6C7]"><Link to="/">ACCESSORIES</Link></li>
        <li className="nav_item inline mb-0 text-[#C5C6C7]"><Link to="/">COVERS & PROTECTORS</Link></li>
        <li className="nav_item inline mb-0 text-[#C5C6C7]"><Link to="/repairs">REPAIRS</Link></li>
        <li className="nav_item inline mb-0 text-[#C5C6C7]">
          <Link to="/trackorder">
            <Button style={{ background: 'blue' }} className="flex gap-x-2">
        ...
        <li className="inline-flex gap-x-8 items-center mb-0">
          <Drawer>
            <DrawerTrigger>
              <button>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#C5C6C7" className="size-6">
        ...
        <li className="nav_item inline-flex gap-x-2 mb-0 cursor-pointer text-[#C5C6C7]">
          <Link to="/signin" className="text-sm">
            <Button style={{ background: 'blue' }}>SIGNIN</Button>
          </Link>
          <Link to="/signup" className="text-sm">
            <Button style={{ background: 'blue' }}>SIGNUP</Button>
          </Link>
        </li>
      </ul>
    </nav>
